...
Test cases:
1) Normal: "Cecya jimenez juarez" -> Formatted name: Juan Carlos Tovar | Initials: C.J.J
...
Test cases:
1) Normal: "cecya@gmail.com" -> Valid email: true 
2) Border: "cecya@gmail -> Valid email: false
3) Error: "cecya at gmail.com" -> Invalid email format.
